...
MQTT_PORT = 1883
MQTT_TOPICS = [
    ('blue/uas/uavision/ogassa', 1),
    ('blue/uas/uavision/elanos', 2),
    ('blue/uas/beyondvision/vtone', 3),
    ('blue/uas/beyondvision/qone', 4),
    ('blue/uas/beyondvision/heifu', 5),
    ('blue/uas/connectrobotics', 6),
    ('blue/uas/inesctec/stork', 7),
    ('blue/uas/synopsisplanet', 8),
    ('blue/uas/arditi/alfa/interior', 9),
    ('blue/uas/arditi/alfa/exterior', 10),
    ('blue/uas/arditi/bravo', 11)
]
MQTT_TOPIC = 'blue/uas/ist/eyeinthesky'  # Define o tópico onde o JSON será publicado
