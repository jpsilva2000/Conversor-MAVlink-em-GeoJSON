...
MQTT_PORT = 1883
MQTT_TOPIC = 'ugs_ist_vigilant'
MQTT_SUBSCRIBE_TOPIC = '#'

# ICAO address encoding mapping
icao_mapping = {
    "Uavision": 1,
    "Tribe": 2
...
def on_message(client, userdata, msg):
    ...
    try:
        ...
        # Verifica se o JSON contém "object": "UAS"
        if payload.get("properties", {}).get("object") == "UGS" and payload.get("properties", {}).get("uxs_name") != "Vigilant":
...
def json_to_mavlink(json_data):
    ...
    try:
        ...
        # Use the mapping to get the ICAO ID
        icao_id = icao_mapping.get(data["properties"]["uxs_name"], 0)
